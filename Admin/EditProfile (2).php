        ...
        <div class="row">  
            ...
            <?php 
                if (isset($_POST['saveEdit'])) { 
                    ...
                    if(mysqli_query($db, "UPDATE user SET department = '$department' ,firstname = '$firstname' ,middlename = '$middlename' ,lastname = '$lastname' ,phone = '$phone' ,woreda = '$woreda' ,email= $email WHERE User_Namee ='$_SESSION[username]' ")){
                    ?>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-6 col-xl-4 text-center text-lg text-gray-100 bg-gradient-success text" style="margin: 0 auto; margin-bottom:10px;"> 
                            Profile Has Been Successfully Updated <strong> <?php echo  $assignto; ?> </strong>
                        </div>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pl-1 mt-2 mx-auto ">
                                            <div class="form-group"> 
                                                <input type="submit" name="saveedit" class="form-control btn btn-sm btn-primary" value="Update Profile " name="submitImage">
                                            </div>
                                        </div>
                                    </div>
                                </form>
