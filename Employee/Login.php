                ...
                <div class="x_panel"  style="text-align:center;" >
                    ...
                    <?php 
                        if(isset($_POST['login'])){
                            ...
                            $count = 0;
                            $result = mysqli_query($db, "SELECT * FROM user WHERE User_Namee='$username' AND User_Password='$password' AND  User_Type='EMPLOYEE' ");
...
<?php
    /*if(!isset($_SESSION['employee']) && !empty($_SESSION['username']) && ($_SESSION['username']) ){ 
        echo "<script type='text/javascript'>alert(' Already Logged In');</script>";
        header( "location: displayuser.php" );  
    } 

    /*if($_SESSION['usertype'] !=="EMPLOYEE" && isset($_SESSION['username']) || !empty($_SESSION['username'])){ 
