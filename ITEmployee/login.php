<?php  
    ...
    if(isset($_SESSION['usertype']) ){
        if(isset($_SESSION['username']) && $_SESSION['usertype'] == "IT EMPLOYEE" ) {
            ?>
                ...
                <div class="x_panel"  style="text-align:center;" >
                    ...
                    <?php 
                        if(isset($_POST['login'])){
                            ...
                            $count = 0;
                            $result = mysqli_query($db, "SELECT * FROM user WHERE User_Namee='$username' AND User_Password='$password' AND  User_Type='IT EMPLOYEE'  ");
                            ...
                            if ($count==0)  {	
                                echo '<div class= "alert alert-danger alert-dismissible fade show " id= "alertmsg" >   
                            ...
                            elseif ($row['User_Status'] == "ACCEPTED") { 
                                ...
                                header("Refresh:3; url= displayuser.php" ); 
                            ...
                            elseif ($row['User_Status'] == "PENDING") { 
                                ...
                                echo '<div class= "alert alert-warning alert-dismissible fade show" id= "alertmsg" >   
                                        <button type="button" class="close" data-dismiss="alert">&times;</button>
